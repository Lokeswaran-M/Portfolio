      ...
      >
        ...
        >
          ...
          <motion.button 
            ...
            className="px-6 py-3 bg-white text-gray-800 border border-gray-300 rounded-full shadow-md cursor-pointer transition-colors duration-300 hover:bg-gray-50 font-medium"
          >
            Contact Me
          </motion.button>
        </motion.div>
